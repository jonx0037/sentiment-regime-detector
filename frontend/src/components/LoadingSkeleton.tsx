    ...
    return (
      <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 ${className}`}>
        <div className="animate-pulse">
          ...
          {/* Chart area */}
          <div className="h-72 bg-gradient-to-b from-gray-100 to-gray-50 rounded-lg flex items-end justify-around px-4 pb-4">
            {[...Array(8)].map((_, i) => (
              <div
                key={i}
  ...
  return (
    <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-6 ${className}`}>
      <div className="animate-pulse space-y-4">
        ...
        <div className="pt-4">
          <div className="h-20 bg-gradient-to-b from-gray-100 to-gray-50 rounded"></div>
        </div>
      </div>
    </div>
  )
