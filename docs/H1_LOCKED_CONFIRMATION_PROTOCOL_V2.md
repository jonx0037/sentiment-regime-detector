# H1 Locked Confirmation Protocol V2

## Purpose
Re-run the locked H1 confirmation analysis with an expanded event universe while preserving the same decision thresholds from Protocol V1.
...
PYTHONPATH=src python scripts/run_h1_locked_confirmation.py \
  --protocol-id H1_LOCKED_CONFIRMATION_PROTOCOL_V2 \
  --events-json docs/h1_event_universe_v2.json
```

## Output Artifacts
- `results/validation/h1_confirmation/locked_protocol/h1_locked_confirmation_20260216_021242.json`
- `results/validation/h1_confirmation/locked_protocol/h1_locked_confirmation_20260216_021242.md`
